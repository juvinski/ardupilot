...
#include "AP_Relay.h"
  ...
  #elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_BBAI
    #define RELAY1_PIN_DEFAULT 242
    #define RELAY2_PIN_DEFAULT 105
    #define RELAY3_PIN_DEFAULT 106
    #define RELAY4_PIN_DEFAULT 235
    #define RELAY5_PIN_DEFAULT 107
    #define RELAY6_PIN_DEFAULT 108
  #endif
#endif
