...
#include "HumidityTemperature_Backend.h"
 ...
 # define DHT_PIN   45 // GPIO P8_11
#else
 # define DHT_PIN     0 // pin undefined on other boards
#endif

class AP_HumidityTemperature_DHT22 : HumidityTemperature_Backend
{
public:
    //Constructor
    AP_HumidityTemperature_DHT22(HumidityTemperature &_humiditytemperature);
